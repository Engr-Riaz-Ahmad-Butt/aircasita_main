...
export const PropertyCard = ({ title, image, distance,guests, bedrooms, beds, baths, price, cancellation }) => {
  return (
    <div className="h-full max-w-md mx-auto mt-8 ">
    <div className="bg-white overflow-hidden rounded-lg shadow-md">
      <Image src={image} alt="Listing Image" className="w-full h-48 object-cover object-center" />
